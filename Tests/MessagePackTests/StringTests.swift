...
class StringTests: XCTestCase {
    ...
    static var allTests : [(String, (StringTests) -> () throws -> Void)] {
        return [
            ("testSerializerFixStr", testSerializerFixStr),
            ("testDeserializerFixStr", testDeserializerFixStr),
            ("testSerializerStr8", testSerializerStr8),
            ("testDeserializerStr8", testDeserializerStr8),
            ("testSerializerStr16", testSerializerStr16),
            ("testDeserializerStr16", testDeserializerStr16),
            ("testSerializerStr32", testSerializerStr32),
            ("testDeserializerStr32", testDeserializerStr32),
        ]
    }
}
